...
public class DownLoadManager {
    ...
    private void init(Context context) {
        ...
        userID = sharedPreferences.getString("UserID",FileHelper.getUserID());
    ...
    public int addTask(String TaskID, String url, String fileName, String filepath) {
        ...
        if (filepath == null) {
            filepath = getDefAttachmentFilePath(fileName);
        }
        FileUtil.isExistFolderFromFile(filepath);
     ...
     */
     private int getAttachmentState(String TaskID, String fileName, String filepath) {
        ...
        File file = null;
        if (filepath == null) {
            file = new File(getDefAttachmentFilePath(fileName));
            if (file.exists()) {
                return -1;
            }
        } else {
     ...
     * @return
     */
    public String getDefAttachmentFilePath(String fileName)
    {
        return FileHelper.getFileDefaultPath(mycontext) + "/" + fileName;
    }
